...
(
  ...
  input wire        zkn_en_i,
  input  wire [31:0] zkn_operand_a_i,
  input  wire [31:0] zkn_operand_b_i,
  input  wire [ 1:0] zkn_imm_i,
  input  wire [K_OP_WIDTH-1:0] zkn_operator_i,
  ...
  begin
    ...
    if (apu_valid & (apu_singlecycle | apu_multicycle)) begin
      ...
      if (zkn_en_i) 
        regfile_alu_wdata_fw_o = zkn_result;
      if (alu_en_i)
  ...
  // LSU write port mux
  //TODO: check for contentions with zkne
  always @(*)
  begin
...
//         $error("%t, wb-contention", $time);
  ...
  (
      .clk   (clk),
      .operand_a_i         ( zkn_operand_a_i ),
      .operand_b_i         ( zkn_operand_b_i ),
      .imm_i ( zkn_imm_i),
      .operator_i ( zkn_operator_i),
...
*/
  ...
  assign ex_valid_o = (zkn_en_i | apu_valid | alu_en_i | mult_en_i | csr_access_i | lsu_en_i)
