...
(
  ...
  riscv_data_cache  small_cache
  (
    .clk          ( clk           ),
    .rst_n        ( rst_n           ),

    .idata_req_o   ( data_req_o),
    .idata_addr_o  ( data_addr_o),
    .idata_we_o    ( data_we_o ),
    .idata_be_o    ( data_be_o ),
    .idata_wdata_o ( data_wdata_o),

    .odata_req_o   ( odata_req_o),

    .idata_gnt_i   (idata_gnt_i),
    .idata_rvalid_i(idata_rvalid_i),
    .idata_err_i   (idata_err_i),
    .idata_rdata_i (idata_rdata_i),

    .odata_gnt_i   (data_gnt_i),
    .odata_rvalid_i(data_rvalid_i),
    .odata_err_i   (data_err_i),
    .odata_rdata_i (data_rdata_i)
