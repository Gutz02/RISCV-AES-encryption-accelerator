...
(
  ...
  output reg zkn_en_o,
  output reg [K_OP_WIDTH-1:0] zkn_operator_o,
    ...
    instr_multicycle_o          = 1'b0;
     ...
     case (instr_rdata_i[6:0])
      ...
      OPCODE_OP: begin  // Register-Register ALU operation
        ...
        //TODO: check that fucnt3 is 000
        case (instr_rdata_i[29:25])
            5'b10011: begin //aes32esmi 
                alu_en_o = 1'b0;
                zkn_en_o = 1'b1;
                regb_used_o         = 1'b1;
                zkn_operator_o = K_ESMI;
                //TODO: issue illegal instruction when func3 is not 0

            end
            5'b10001: begin //aes32esi 

                alu_en_o = 1'b0;
                zkn_en_o = 1'b1;
                regb_used_o         = 1'b1;
                zkn_operator_o = K_ESI;
                //TODO: issue illegal instruction when func3 is not 0
            end
            default: begin
