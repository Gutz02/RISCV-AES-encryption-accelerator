...
(
    ...
    // ZKN
    output reg        zkn_en_ex_o,
    output reg [31:0] zkn_operand_a_ex_o,
    output reg [31:0] zkn_operand_b_ex_o,
    output reg [1:0]  zkn_imm_ex_o,
    output reg [K_OP_WIDTH-1:0]  zkn_operator_ex_o ,
  ...
  wire        zkn_en;
  reg  [1:0] zkn_imm_id;
  wire [K_OP_WIDTH-1:0] zkn_operator;
  ...
  // immediate zkn type
  assign imm_zkn_type = instr[31:30];
...
////////////////////////////////////////////////////////////////////////
  ...
  begin : ID_EX_PIPE_REGISTERS
    ...
    begin
      zkn_en_ex_o                 <= 0;
      zkn_operand_a_ex_o          <= 0;
      zkn_operand_b_ex_o          <= 0;
      zkn_operator_ex_o           <= K_ESI;
      ...
      begin // unstall the whole pipeline
        ...
        if (zkn_en) 
        begin
          zkn_operand_a_ex_o        <= alu_operand_a;
          zkn_operand_b_ex_o        <= alu_operand_b;
          zkn_imm_ex_o              <= zkn_imm_id;
          zkn_operator_ex_o         <= zkn_operator;
        end
