...
(
  ...
  //ZKN Control
  wire        zkn_en_ex;
  wire [31:0] zkn_operand_a_ex;
  wire [31:0] zkn_operand_b_ex;
  wire [ 1:0] zkn_imm_ex;
  wire [K_OP_WIDTH-1:0] zkn_operator_ex;
...
`endif
  ...
  (
    ...
    .zkn_en_ex_o                  (zkn_en_ex             ),
    .zkn_operand_a_ex_o           (zkn_operand_a_ex     ),
    .zkn_operand_b_ex_o           (zkn_operand_b_ex     ),
    .zkn_imm_ex_o                 (zkn_imm_ex           ),
    .zkn_operator_ex_o            ( zkn_operator_ex      ),
  ...
  (
    ...
    // ZKN signals from ID stage
    .zkn_en_i                   ( zkn_en_ex                    ),
    .zkn_operand_a_i            ( zkn_operand_a_ex             ), // from ID/EX pipe registers
    .zkn_operand_b_i            ( zkn_operand_b_ex             ), // from ID/EX pipe registers
    .zkn_imm_i                  ( zkn_imm_ex                   ),
    .zkn_operator_i             ( zkn_operator_ex              ), // from ID/EX pipe registers
  ...
  (
    ...
    .odata_req_o            ( data_req_o         ),
    .idata_gnt_i            ( data_gnt_i         ),
    .idata_rvalid_i         ( data_rvalid_i      ),
    .idata_err_i            ( data_err_i         ),

    .data_addr_o           ( data_addr_o        ),
    .data_we_o             ( data_we_o          ),
    .data_be_o             ( data_be_o          ),
    .data_wdata_o          ( data_wdata_o       ),
    .idata_rdata_i          ( data_rdata_i       ),
