module sbox (
    ...
    // use this to ensures its treated like read-only
    (* rom_style = "distributed" *) reg [7:0] sbox_table [0:255];

    // used python to generate this table
    initial begin
    ...
    assign byte_o = sbox_table[byte_i];
